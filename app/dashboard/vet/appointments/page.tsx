...
const translations = {
  en: {
    ...
    // Vet specific
    vetSubtitle: "Manage your client appointments",
    client: "Client",
    animal: "Animal",
    ...
    viewMedicalHistory: "View History",
    addNotes: "Add Notes",
    // Owner specific
    ownerSubtitle: "Manage your veterinary care schedule",
  ...
  rw: {
    // Common
    title: "Ibiganiro",
    subtitle: "Gucunga ibiganiro by'ubuganga bw'itungo",
    ...
    // Vet specific
    vetSubtitle: "Gucunga ibiganiro by'abakiriya",
    client: "Umukiriya",
    animal: "Itungo",
    clientContact: "Aho Umukiriya abarizwa",
    animalInfo: "Amakuru y'itungo",
    acceptAppointment: "Emeza",
    rejectAppointment: "Hanga",
    rescheduleAppointment: "Hindura igihe",
    viewMedicalHistory: "Reba Amateka",
    addNotes: "Ongeraho Ibisobanuro",
    // Owner specific
    ownerSubtitle: "Gucunga gahunda y'ubuganga bw'itungo",
...
export default function AppointmentsPage() {
  ...
  const fetchUserAndAppointments = async () => {
    try {
      ...
      const endpoint = user.role === 'vet' 
        ? `/api/appointments?vet_id=${user.id}`
        : `/api/appointments?user_id=${user.id}`
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-gray-600 text-lg">{isVet ? t.vetSubtitle : t.ownerSubtitle}</p>
            </div>
            <button
                  ...
                  <div className="p-6">
                    ...
                    <div className="mb-6">
                      <h4 className="text-sm font-medium text-gray-500 mb-3">
                        {isVet ? t.clientContact : t.vetContact}
                      </h4>
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          <h4 className="font-semibold text-gray-900">
                            {isVet 
                              ...
                              : (appt.vet_name || 'Dr. Veterinarian')}
                          </h4>
                          <div className="flex items-center gap-4 text-sm text-gray-600 mt-1">
                            <span><i className="bi bi-envelope mr-1"></i>
                              {isVet ? appt.user_email : appt.vet_email}
                            </span>
                            <span><i className="bi bi-telephone mr-1"></i>
                              {isVet ? appt.user_phone : appt.vet_phone}
                            </span>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 mb-6">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm text-gray-500">{isVet ? t.animalInfo : t.animal}</p>
                        ...
                        <>
                          {appt.status === 'pending' && (
                            <>
                              <button
                                ...
                                className="flex-1 px-4 py-2.5 text-sm font-medium text-white bg-green-600 rounded-xl hover:bg-green-700 transition-colors"
                              >
                          ...
                          {appt.status === 'confirmed' && (
                            <button
                              ...
                              className="flex-1 px-4 py-2.5 text-sm font-medium text-white bg-gradient-to-r from-green-600 to-emerald-600 rounded-xl hover:shadow-md transition-all"
                            >
                          ...
                          <button className="flex-1 px-4 py-2.5 text-sm font-medium text-gray-700 bg-gray-100 rounded-xl hover:bg-gray-200 transition-colors">
                            <i className="bi bi-file-medical mr-1"></i>
