              ...
              <div className="flex items-end gap-3">
                ...
                <div className="flex-1">
                  <textarea
                    ...
                    className="w-full px-4 min-h-[5vh] py-2 bg-gray-100 border-0 rounded-lg resize-none focus:ring-2 focus:ring-green-500 outline-none text-gray-600"
                    rows={1}
                  />
                </div>
                <button className="p-2 hover:bg-gray-100 rounded-lg">
